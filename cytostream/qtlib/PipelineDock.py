...
class PipelineDock(QtGui.QWidget):
    ...
    def __init__(self, parent=None, eSize=35):
        ...
        self.eSize = eSize
        self.buff = 2.0
        self.btnColor = QtGui.QColor(220, 0, 0)
    ...
    def create_buttons(self):
        ...
        self.dataProcessingBtn.setMaximumWidth(self.eSize*7.0)
        self.dataProcessingBtn.setMinimumWidth(self.eSize*7.0)
        ...
        self.qualityAssuranceBtn.setMaximumWidth(self.eSize*7.0)
        self.qualityAssuranceBtn.setMinimumWidth(self.eSize*7.0)
        ...
        self.modelBtn.setMaximumWidth(self.eSize*7.0)
        self.modelBtn.setMinimumWidth(self.eSize*7.0)
        ...
        self.resultsNavigationBtn.setMaximumWidth(self.eSize*7.0)
        self.resultsNavigationBtn.setMinimumWidth(self.eSize*7.0)
