...
from BulkOpenProject import BulkOpenProject
...
class BulkOpenProjectTest(unittest.TestCase):
    ...
    def testConstruction(self):
        ...
        self.root = tk.Tk()
        self.bulkOpenProject = BulkOpenProject(self.root,existingProjects,bg='#333333')#command=view.open_existing_project,loadBtnFn=view.open_existing_project 
        self.bulkOpenProject.pack()
