...
make_plots_as_subplots(expListNames,expListData,expListLabels,centroids=beforeStats['mus'],showCentroids=True,
                       figTitle='Before File Alignment',saveas=beforeFig,refFile=fa.refFile,subplotRows=2,
                       subplotCols=3)
for phi in phiRange:
    ...
    pcc = PieChartCreator(fa.newLabelsAll[str(round(phi,4))],expListNames+["copied ref file"],saveas=pieChartSave)
    ...
    make_plots_as_subplots(fa.expListNames,fa.expListData,fa.newLabelsAll[str(round(phi,4))],centroids=afterStats['mus'],showCentroids=True,
                           figTitle='After File Alignment',saveas=afterFig,refFile=fa.refFile,subplotRows=2,
                           subplotCols=4)
